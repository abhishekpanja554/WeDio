              ...
              title: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Calls call = Calls(
                        callId: Random().nextInt(1000).toString(),
                        callerId: _helper.getCurrentUser()!.uid,
                        recieverId: widget.chatParticipant!.uid,
                        conversationId: widget.conversationId,
                      );
                      UtilityClass.makeCall(
                      ...
                      if (snapshot.hasData) {
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            String date = DateFormat.yMMMMd().format((snapshot
                                    .data!.docs[index]
                                    .data()['time_stamp'])
                                .toDate());
                            bool isRead = snapshot.data!.docs[index]
                                        .data()['isRead'] ==
                                    null
                                ? null
                            ...
                            if (!isRead &&
                                !(snapshot.data!.docs[index].data()['sender'] ==
                                    _helper.getCurrentUser()!.uid)) {
                              sendReadAchk(
                                  isRead, snapshot.data!.docs[index].id);
                            }
                            return ChatBubble(
                              message:
